% The physics of gptci -- user guide.
...
\title{\textbf{The physics of \texttt{gptci}}\\[2pt]
  \large The Gross--Pitaevskii equation on quantics tensor trains}
\date{}
...
\noindent
2D is \code{gptci.evolve2d.evolve}, with the same shape of call plus
